<template>
  <div class="min-[1160px]:my-[30px] my-5">
    ...
    <div :class="['relative w-full p-[2px] rounded-[13px] min-[1160px]:mt-[15px] min-[1160px]:mb-[10px] my-2.5',this.invalidClass? 'focus:border bg-[#E86068] border-[#E86068]': 'focus:bg-gradient-to-l focus-within:bg-gradient-to-l focus from-[#E2C299] from-[6%] to-[94%] to-[#C5A67C]',]">
      <input type="text" v-model="this.seletedOpt" @focus="onFocus" @input="onInput"
        class="h-[51px] min-[1160px]:text-base text-sm min-[1160px]:px-5 min-[1160px]:py-4 p-4 w-full rounded-[12px] bg-white border border-[#000000]/10 text-[--color-opacity-6] min-[1160px]:text-base text-sm focus:outline-none focus:border-transparent hover:border-[#000000]/30 hover:text-[--color] hover:placeholder:text-[--color]"
        id="name"
